const products = [
  ...
  },
  {
    ...
    detail:
      "Many AI tools assume data can leave the organisation. For some teams that assumption alone makes them unusable.\n\nWorkspace treats AI as a local capability instead of an external service. The system retrieves internal context, processes it within the organisation boundary, and returns assistance without exporting behavioural data.\n\nRather than replacing workflows, it sits alongside them — summarising information, assisting decisions, and keeping activity traceable.\n\nThis allows teams to experiment with AI in environments where external processing would normally stop adoption entirely.",
